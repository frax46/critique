  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900 dark:to-purple-900 flex items-center justify-center p-4">
      <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl p-8 max-w-4xl w-full">
        ...
        <svg
          className="absolute top-0 left-0 -mt-12 -ml-12 text-blue-500 opacity-50 h-24 w-24"
          fill="currentColor"
          viewBox="0 0 100 100"
        >
        ...
        <svg
          className="absolute bottom-0 right-0 -mb-12 -mr-12 text-purple-500 opacity-50 h-24 w-24"
          fill="currentColor"
          viewBox="0 0 100 100"
        >
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            {tiers.map((tier) => (
              <div
                key={tier.id}
                className="bg-blue-50 dark:bg-blue-900 rounded-lg overflow-hidden shadow-md transition duration-300 hover:shadow-xl flex flex-col content-between "
              >
                <div className="p-6">
                  <h2 className="text-2xl font-semibold mb-2 text-blue-800 dark:text-blue-300">
                    {tier.name}
                  </h2>
