...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-4 left-0 right-0 w-11/12 mx-auto z-50 transition-all duration-300 ${
      scrolled ? 'py-2' : 'py-3'
    } bg-white bg-opacity-60 backdrop-blur-md rounded-2xl shadow-md`}>
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            <Image src="/logo_homecritique.png" alt="Logo" width={40} height={40} className="mr-2" />
          </div>
          <div className="hidden md:flex items-center space-x-1">
            ...
            <NavLink href="/subscribe" active={pathname === '/subscribe'}>Subscribe</NavLink>
      ...
      {isOpen && (
        <div className="md:hidden bg-white shadow-lg rounded-b-3xl overflow-hidden mt-2">
          ...
          <NavLink href="/about" active={pathname === '/about'} mobile>About</NavLink>
          <NavLink href="/services" active={pathname === '/services'} mobile>Services</NavLink>
          <NavLink href="/contact" active={pathname === '/contact'} mobile>Contact</NavLink>
          <NavLink href="/subscribe" active={pathname === '/subscribe'} mobile>Subscribe</NavLink>
...
const NavLink: React.FC<NavLinkProps> = ({ href, children, active, mobile = false }) => {
